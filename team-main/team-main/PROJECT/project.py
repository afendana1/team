...
def spawner(x,y,chance):
    '''спавнер мобов'''
    if randint(1,100)<40/((chance+4)*2):
...
#       стрельба:
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_e:
                if distance_to(hero.x,hero.y,my_portal.x,my_portal.y)<my_portal.radius-hero.radius:
                    my_portal.teleport()
